...
namespace iqchampion_design.ServiceReference {
    ...
    public interface IIQService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IIQService/getTimeLeft", ReplyAction="http://tempuri.org/IIQService/getTimeLeftResponse")]
        int getTimeLeft(string user);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IIQService/getTimeLeft", ReplyAction="http://tempuri.org/IIQService/getTimeLeftResponse")]
        System.Threading.Tasks.Task<int> getTimeLeftAsync(string user);
    ...
    public partial class IQServiceClient : System.ServiceModel.ClientBase<iqchampion_design.ServiceReference.IIQService>, iqchampion_design.ServiceReference.IIQService {
        ...
        public int getTimeLeft(string user) {
            return base.Channel.getTimeLeft(user);
        }
        
        public System.Threading.Tasks.Task<int> getTimeLeftAsync(string user) {
            return base.Channel.getTimeLeftAsync(user);
        }
